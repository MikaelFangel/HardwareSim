...
public class main {
    public static void main(String[] args) throws IOException, ConditionException, UpdateException {
...
class Interpreter extends AbstractParseTreeVisitor<AST> implements hwsimVisitor<AST> {
    ...
    public AST visitSimIn(hwsimParser.SimInContext ctx) {
        List<Value> binaries = new ArrayList<>();
        for (var binary : ctx.b) {
            Value bool = new Value(binary.getText().equals("1"));
            binaries.add(bool);
        }
